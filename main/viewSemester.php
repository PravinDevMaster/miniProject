...
<body class="bg-primary">
    ...
    <div class="header d-flex justify-content-between text-white pt-0 pb-0 p-5">
        ...
        <div class="return ">
            <p><a href="./index.php">Home</a> / Semester</p>
        </div>
    </div>
    <div class="container">
        <div class="row  d-flex justify-content-center">
            ...
            FROM class c 
            LEFT JOIN semester s ON s.class_id = c.class_id  WHERE s.sem_complete = 0 AND (s.active = 0 OR s.active = 1) ";
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($row['active'] == 1) {
                        $status = "Active";
                        $color = "success";
                    } elseif ($row['sem_num'] == $row['highest_sem']) {
                        $status = "Complete";
                        $color = "primary";
                    } else {
                        $status = "Unactive";
                    ...
                    ?>
                    <a href="./semester.php?class_id=<?php echo $row['class_id']; ?>"
                        class="fields1 col-10 col-lg-3  m-4 mt-3 mb-3">
                        <p class="txt1">
                        ...
                        <div class="txt3 d-flex justify-content-between pt-0 pb-0 p-4">
                            <span>
                                <?php echo $semester; ?>
                            </span>
                            <span class="btn btn-<?php echo $color; ?> text-wrap"><?php echo $status; ?></span>
                        </div>
                    </a>
