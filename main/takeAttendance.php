...
<body class="bg-primary">
  ...
  <div class="header d-flex justify-content-between text-white pt-0 pb-0 p-5">
    ...
    <div class="return ">
      <p><a href="./index.php">Home</a> / Take Attendance</p>
    </div>
  </div>
  <div class="container">
    <div class="row  d-flex justify-content-center">
      ...
      WHERE s.sem_complete = 0 AND s.active = 1";
      ...
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          ?>
          <a href="./attendance.php?class_id=<?php echo $row['class_id']; ?>&sem_num=<?php echo $row['sem_num']; ?>"
      ...
      <div class="fields1 col-10 col-lg-2  m-4 mt-3 mb-3" style="display:none;">
